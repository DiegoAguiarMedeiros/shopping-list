...
function ListGrid({
  ...
  const totalQuantity = getTotalQuantityAmountByListUuidController.handle(tagUuid, listArrItems);
  const total = getTotalAmountByListProductUuidController.handle(tagUuid, listArrItems);
