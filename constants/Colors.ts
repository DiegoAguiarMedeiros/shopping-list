...
export default {
  light: {
    ...
    menuButtonActiveColor: primary,
    backgroundBottomSheet: "#eee",
    bottomSheetButtonAddBackground: primary,
    bottomSheetButtonCancelBackground: "#aaa",
    bottomSheetButtonAddBorder: primary,
    ...
    bottomSheetButtonAddUnderlay: secondary,
    ...
    itemListItemOpenButtonBorder: primary,
    itemListItemOpenButtonBackGround: primary,
    itemListItemOpenIcon: "#00000050",
    itemListItemOpenIconFilled: primary,
    itemListItemOpenButtonText: "#fff",
    itemListItemOpenButtonSendBorder: primary,
    itemListItemOpenButtonSendBackGround: primary,
    itemListItemOpenButtonSendText: "#fff",
    itemListItemOpenTrashIcon: primary,
    swipeIcon: "#00000050",
    swipeIconUnderlay: "#eee",
    circularItemBackground: "#fff",
    circularItemText: "#00000050",
    circularItemFilled: primary,
    circularHeaderBackground: "#69C9BE",
    circularHeaderText: "#eee",
    circularHeaderFilled: primary,
    filterButtonBackground: "#eeeeee",
    filterButtonBorder: "#eeeeee",
    filterButtonText: "#00000080",
    filterButtonActiveBackground: primary,
    filterButtonActiveBorder: primary,
    filterButtonActiveText: primaryDarkFontColor,
    itemProductListAveragePrice: primary,
    itemProductListLastPriceButtonBorder: primary,
    itemProductListLastPriceButtonText: primary,
  },
  dark: {
    primary,
    secondary,
    ...
    itemListItemOpenBackgroundUnderlay: primary,
    ...
    circularItemText: primary,
    circularItemFilled: primary,
    circularHeaderBackground: primary,
